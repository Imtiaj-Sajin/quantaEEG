...
2. Done 2026-09-15: CRediT roles set for all five authors; single-anonymous
   review chosen, so there is one manuscript and one `submission.zip`.
3. `\funding{}` says no grant. Confirm Chayon's affiliation.
